//goToPets
document.querySelector('#make-a-friend').addEventListener('click', () => { document.location.href = '../pets/index.html' })
document.querySelector('#get-to-know').addEventListener('click', () => { document.location.href = '../pets/index.html' })
...
function completePets() {
    for (let index = 0; index < 3; index++) {
        document.querySelector(`#img-animal-${index}`).src = pets[index].img
        document.querySelector(`#name-animal-${index}`).textContent = pets[index].name
    }
}
...
function previousSlide() {
    let firstName = document.querySelector('#name-animal-0').textContent
    let ind = 0
    ...
    for (let index = 0; index < 3; index++) {
        document.querySelector(`#img-animal-${index}`).src = pets[ind].img
        document.querySelector(`#name-animal-${index}`).textContent = pets[ind].name
        if (ind === 7) {
            ind = -1
        }
        ind++
...
function nextSlide() {
    let firstName = document.querySelector('#name-animal-2').textContent
